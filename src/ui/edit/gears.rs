...
use iced::widget::{Column, Row, Text, text, text_input, TextInput};
...
pub(super) fn gear_configuration_builder(ac_car_path: &PathBuf) -> Result<Box<dyn GearConfiguration>, String> {
